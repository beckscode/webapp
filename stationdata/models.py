...
# Create your models here. The following is only a guide for future work.
# https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Models
# https://docs.djangoproject.com/en/3.1/ref/models/fields/#field-options
# https://postgis.net/docs/  &  https://postgis.net/features/       
# TODO: create preliminary diagrams for tables, data, keys. Key on date or type of object detected? Secondary key? Postgis key = location coordinates.
